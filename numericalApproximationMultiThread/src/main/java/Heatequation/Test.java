...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        double lcm1 = SystemOfEquations.getLcmDouble(-2,496125);
        double lcm2 = SystemOfEquations.getLcmDouble(8000,-2);
        double lcm3 = SystemOfEquations.getLcmDouble(5,4);
        double lcm4 = SystemOfEquations.getLcmDouble(40008,8);
        double lcm5 = SystemOfEquations.getLcmDouble(15600,13);
        double lcm6 = SystemOfEquations.getLcmDouble(1.5,4.5);
